        ...
        while True:
            try: 
                ...
                for t in range(self.T):
                    ...
                    x_next = torch.sqrt(1-self.beta[t]) * x + self.beta[t] * torch.randn_like(x)

                    x_rec = torch.rsqrt(self.alpha[t]) * (x - self.beta[t] / torch.rsqrt(1 - alpha_bar) * self.model(x_next))
